...
- [Kafka 분산 시스템 설계: 파티셔닝, 데이터 정합성](kafka-deepdive.html)
...
- [Spring AOP & Cache](Spring-AOP,-Cache.html)
...
- [Tomcat performance tuning](Tomcat-performance-tuning.html)

## Data (RDB / NoSQL / Cache)
- [계층적 데이터 모델링](계층적-데이터-모델링-기법.html)
- [데이터베이스 성능 최적화](데이터베이스-성능-최적화.html)
- [MongoDB](MongoDB.html)
  - [MongoDB 운영](MongoDB-운영-가이드.html)
- [Redis](Redis.html)
  - [Redis 데이터 타입과 모델링](Redis-데이터-타입과-모델링.html)
  - [Redis cache penetration/avalanche/breakdown](Redis-cache-penetration,-cache-avalanche,-cache-breakdown.html)
...
- [Clean Code 사례](Clean-Code-사례.html)
- [Design Patterns](Design-Patterns.html)

## Algorithms & Data Structures
- [Algorithm](Algorithm.html)
- [해시함수의 정의, 특징, 활용예시](해시함수의-정의,-특징,-활용예시.html)
- [BitMap & BloomFilter](대용량-데이터-중복-제거-‐-bitmap,-Bloom-filter.html)

## Tools (Local / CLI)
- [Linux Command](Linux-Command.html)
- [Vim 단축키](Vim-단축키.html)

## Projects & Templates
- [온디맨드 비디오 서비스](On‐Demand-Streaming-Video-Streaming-Service.html)
- [프로젝트 문서 템플릿](프로젝트-문서-템플릿.html)
- [멀티리포 vs 모노리포](멀티리포-vs-모노리포.html)
